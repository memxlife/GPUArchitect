...
def run_research_round(layout: WorkspaceLayout, question_text: str) -> ResearchRoundResult:
    ...
    question, spec = planner.plan(question_text)
    ...
    next_step = curator.curate(question, spec, run, observation, claim, verification)
